...
export interface IVoucherService {
    ...
    getVoucherById(requester: Requester, voucherId: string): Promise<Voucher | null> // Lấy thông tin voucher theo ID
    listVouchers(requester: Requester, pagingDTO: PagingDTO, voucherCondDTO: VoucherCondDTO): Promise<Paginated<Voucher>> // Lấy danh sách voucher theo điều kiện
    listVouchersByIds(requester: Requester, voucherIds: string[], pagingDTO: PagingDTO): Promise<Paginated<Voucher>> // Lấy danh sách voucher theo nhiều ID
}
...
export interface IVoucherRepository {
    ...
    listVouchersByIds(voucherIds: string[], paging: PagingDTO): Promise<Paginated<Voucher>> // Lấy danh sách voucher theo nhiều ID
