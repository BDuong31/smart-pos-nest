...
export interface IPaymentService {
    ...
    listPayments(pagingDTO: PagingDTO, paymentCondDTO: PaymentCondDTO): Promise<Paginated<PaymentTransaction>> // Lấy danh sách giao dịch thanh toán theo điều kiện
    listPaymentsByIds(paymentIds: string[]): Promise<PaymentTransaction[]> // Lấy danh sách giao dịch thanh toán theo nhiều ID
