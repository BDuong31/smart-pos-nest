...
export interface IOrderService {
    ...
    listOrders(pagingDTO: PagingDTO, orderCondDTO: OrderCondDTO): Promise<Paginated<Order>> // Lấy danh sách đơn hàng theo điều kiện
    listOrdersByIds(orderIds: string[]): Promise<Order[]> // Lấy danh sách đơn hàng theo nhiều ID
    ...
    listOrderItems(pagingDTO: PagingDTO, orderItemCondDTO: OrderItemCondDTO): Promise<Paginated<OrderItem>> // Lấy danh sách mục sản phẩm trong đơn hàng theo điều kiện
    listOrderItemsByIds(orderItemIds: string[]): Promise<OrderItem[]> // Lấy danh sách mục sản phẩm trong đơn hàng theo nhiều ID
    ...
    listOrderItemOptions(pagingDTO: PagingDTO, orderItemOptionCondDTO: OrderItemOptionCondDTO): Promise<Paginated<OrderItemOption>> // Lấy danh sách tùy chọn sản phẩm trong mục đơn hàng theo điều kiện
    listOrderItemOptionsByIds(orderItemOptionIds: string[]): Promise<OrderItemOption[]> // Lấy danh sách tùy chọn sản phẩm trong mục đơn hàng theo nhiều ID
    ...
    listOrderVouchers(pagingDTO: PagingDTO, orderVoucherCondDTO: OrderVoucherCondDTO): Promise<Paginated<OrderVoucher>> // Lấy danh sách voucher trong đơn hàng theo điều kiện
    listOrderVouchersByIds(orderVoucherIds: string[]): Promise<OrderVoucher[]> // Lấy danh sách voucher trong đơn hàng theo nhiều ID
    ...
    listOrderTables(pagingDTO: PagingDTO, orderTableCondDTO: OrderTableCondDTO): Promise<Paginated<OrderTable>> // Lấy danh sách bàn trong đơn hàng theo điều kiện
    listOrderTablesByIds(orderTableIds: string[]): Promise<OrderTable[]> // Lấy danh sách bàn trong đơn hàng theo nhiều ID
    ...
    listInvoices(pagingDTO: PagingDTO, invoiceCondDTO: InvoiceCondDTO): Promise<Paginated<Invoice>> // Lấy danh sách hoá đơn công ty theo điều kiện
    listInvoicesByIds(invoiceIds: string[]): Promise<Invoice[]> // Lấy danh sách hoá đơn công ty theo nhiều ID
}
