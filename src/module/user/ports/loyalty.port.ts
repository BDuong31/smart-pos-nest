...
export interface ILoyaltyService {
    ...
    createUserRank(dto: UserRankDTO, ip: string, userAgent: string): Promise<string>; // Tạo hạng khách hàng thân thiết mới
    ...
    createPointHistory(dto: PointHistoryDTO, ip: string, userAgent: string): Promise<string>; // Tạo lịch sử điểm khách hàng thân thiết mới
