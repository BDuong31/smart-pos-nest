...
export interface PublicPointHistory extends z.infer<typeof publicPointHistorySchema> {}
...
export interface PublicOptionGroup extends z.infer<typeof publicOptionGroupSchema> {}
...
export interface PublicOptionItem extends z.infer<typeof publicOptionItemSchema> {}
...
export interface PublicProductOptionConfig extends z.infer<typeof publicProductOptionConfigSchema> {}
...
export interface PublicComboItem extends z.infer<typeof publicComboItemSchema> {}
...
export interface PublicIngredient extends z.infer<typeof publicIngredientSchema> {}
...
export interface PublicUnitConversion extends z.infer<typeof publicUnitConversionSchema> {}
...
export interface PublicInventoryBatch extends z.infer<typeof publicInventoryBatchSchema> {}
...
export interface PublicImportInvoice extends z.infer<typeof publicImportInvoice> {}
...
export interface PublicImportInvoiceDetail extends z.infer<typeof publicImportInvoiceDetail> {}
...
export interface PublicPurchaseProposal extends z.infer<typeof publicPurchaseProposalSchema> {}
...
export interface PublicPurchaseProposalDetail extends z.infer<typeof publicPurchaseProposalDetailSchema> {}
...
export interface PublicStockCheck extends z.infer<typeof publicStockChecSchema> {}
...
export interface PublicStockCheckDetail extends z.infer<typeof publicStockCheckDetailSchema> {}
...
export interface PublicReservation extends z.infer<typeof publicReservationSchema> {}
...
export interface PublicCartItemOption extends z.infer<typeof publicCartItemOptionSchema> {}
...
export interface PublicOrderVoucher extends z.infer<typeof publicOrderVoucherSchema> {}
...
export interface PublicOrderTable extends z.infer<typeof publicOrderTableSchema> {}
...
export interface PublicOrderItemOption extends z.infer<typeof publicOrderItemOptionSchema> {}
...
export const publicPaymentTransactionSchema = z.object({
    ...
    gatewayResponse: z.any().transform((val) => val as Prisma.InputJsonValue).optional(),
...
export interface PublicPaymentTransaction extends z.infer<typeof publicPaymentTransactionSchema> {}
