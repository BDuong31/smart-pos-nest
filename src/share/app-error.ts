...
export const ErrServiceUnavailable = AppError.from(
  new Error('Service unavailable.'),
  503,
); // Lỗi dịch vụ không khả dụng
export const ErrGatewayTimeout = AppError.from(
...
export const ErrUnprocessable = AppError.from(
  new Error('Unprocessable entity.'),
  422,
); // Lỗi thực thể không thể xử lý
export const ErrTooManyRequests = AppError.from(
