import {
  ...
  PublicOptionGroup,
  PublicOptionItem,
  PublicProductOptionConfig,
  PublicCombo,
  PublicComboItem,
  PublicSupplier,
  PublicUnitConversion,
  PublicIngredient,
  PublicInventoryBatch,
  PublicRecipe,
  PublicImportInvoice,
  PublicImportInvoiceDetail,
  PublicPurchaseProposal,
  PublicPurchaseProposalDetail,
  PublicStockCheck,
  PublicStockCheckDetail,
  PublicZone,
  PublicTable,
  PublicReservation,
  PublicCart,
  PublicCartItem,
  PublicCartItemOption,
  PublicVoucher,
  PublicOrder,
  PublicOrderVoucher,
  PublicOrderTable,
  PublicOrderItem,
  PublicOrderItemOption,
...
export interface ReqWithRequester {
  requester: Requester;
} // Requester bắt buộc phải có

export interface ReqWithRequesterOpt {
  requester?: Requester;
} // Requester có thể không có
...
export interface IPublicProductOptionConfigRpc {
  getConfigByProductId(
    productId: string,
  ): Promise<PublicProductOptionConfig | null>;
}
